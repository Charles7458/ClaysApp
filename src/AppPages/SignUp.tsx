    ...
    return(
        <div className="w-full flex justify-center items-center" style={{minHeight:'100vh',fontFamily:'Roboto,sans-serif'}}>
            ...
            <div className='login-div'>
                ...
                <h1 className='login-head text-3xl py-0 font-bold'>Sign Up</h1>
                ...
                <form className='mx-2 mx-md-5 mb-5'>
                    ...
                    <input type='submit' value="Sign Up" className='submit-btn' onClick={()=>console.log(userData)}/>
                </form>
                ...
                <p className='mt-4 text-center'>Have an account? <a className='text-blue-400 cursor-pointer' onClick={()=>navigate("/login")}>Log in?</a></p>
